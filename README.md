...
**Directory layout:**
- `python/<topic>/<problem-folder>/`
- Topic folders group problems by common patterns (e.g., arrays, sliding window, graphs)

**Key design principles:**
- Non-destructive: original files remain untouched
- Organized by topic for pattern-based learning
